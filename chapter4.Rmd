...
LD1 is the first linear discriminant and the LD2 the second. What these exactly represent hopefully becomes clearer next week. The arrows show the direction and extent of the effect of each explanatory variable.
...
Then 3 clusters instead of 2 is used, which seems to bring something new to the clusterization. Rather clear groups can be seen here:
